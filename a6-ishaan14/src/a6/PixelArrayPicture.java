...
abstract public class PixelArrayPicture extends PictureImpl implements Picture {
	...
	/*super is used here to signify that caption is in an upper class. The constructor 
	also initializes the Pixel array through a private constructor*/
	protected PixelArrayPicture(Pixel[][] parray, String caption) {
		super(caption);
		_pixels = copyPixelArray(parray);
	}
	
	/*all methods below are from original repository and 
	are common between ImmutablePixelArray and MutablePixelArray, 
	thereby allowing the use of inheritance*/
	@Override
	public int getWidth() {
